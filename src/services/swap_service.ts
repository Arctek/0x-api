...
export class SwapService {
    ...
    public async calculateSwapQuoteAsync(params: CalculateSwapQuoteParams): Promise<GetSwapQuoteResponse> {
        ...
        const protocolFee = attributedSwapQuote.worstCaseQuoteInfo.protocolFeeInWeiAmount;
        let worstCaseGas = new BigNumber(attributedSwapQuote.worstCaseQuoteInfo.protocolFeeInWeiAmount);
        ...
        if (!isCoordinated) {
            ...
            worstCaseGas = worstCaseGas.plus(1.5e5);
        }
        ...
        let conservativeBestCaseGasEstimate = worstCaseGas.plus(gasTokenGasCost);
